...
const beautyImagePool = [
  ...
  'https://images.unsplash.com/photo-1556228457-b7f2f0bdbb6a?w=400',
...
function generateProducts(count = 40040) {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    const description = `Experience the ${adj.toLowerCase()} touch with our ${noun.toLowerCase()}. Perfect for ${category.toLowerCase()} routine. Cruelty-free and dermatologically tested.`;
